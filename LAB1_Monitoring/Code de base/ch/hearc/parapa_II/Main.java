...
public class Main
{
	...
	private static FutureTask<String> consoleTask = new FutureTask<>(new Callable<String>() 
	{
		...
		public String call() throws Exception 
		{
			...
			/*
			 * ----------------------------------------------------------------------------------------
			 * TODO : Demander a l'utilisateur d'entrer un nombre de documents et un nombre de personne
			 * 
			...
			while (!consoleTask.isCancelled())
			{
				/*
				 * --------------------------------------------------------------------------------------------------------------------
				 * TODO : Lire en continu les inputs de l'utilisateur (prevoir une porte de sortie sur demande d'arret du programme). 
